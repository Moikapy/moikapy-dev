...
const projects: Project[] = [
  ...
  },
  {
    ...
    href: "https://treasury-gov.pages.dev",
  ...
  },
  {
    title: "LoC",
    emoji: "🏛️",
    tagline: "OpenCongress — Track bills, members, votes & committees",
    description: "Browse the US Congress in real time. Bills, members, votes, and committees across multiple sessions — open data, open access.",
    href: "https://loc.moikapy.dev",
    tags: ["Next.js", "Cloudflare", "Open Data"],
    status: "live",
  },
  {
    title: "VitaK Tracker",
    emoji: "💊",
    tagline: "Vitamin K management for warfarin patients",
    description: "Track daily Vitamin K intake with a credit system based on USDA FoodData Central. Color-coded alerts, trend charts, and INR safety — built for consistency.",
    href: "https://vitaktracker.com",
    tags: ["Next.js", "PWA", "Health"],
    status: "live",
  },
  {
    title: "This Blog",
